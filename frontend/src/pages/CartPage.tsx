...
const CartPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 px-4 pb-28">
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-5 items-start">
        ...
        <div className="flex-1 bg-white rounded-lg shadow-sm p-4 md:p-6">
          ...
          {cartItems.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-gray-400 gap-4">
              ...
              <button
                className="bg-yellow-400 text-black font-bold px-6 py-2 rounded-lg text-sm hover:bg-yellow-500"
                onClick={() => navigate("/")}
              >
                กลับไปช้อปปิ้ง
              </button>
            ...
            <>
              {cartItems.map((item) => (
                ...
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row sm:items-center gap-4 py-4 border-b border-gray-50"
                >
                  ...
                  {/* Price */}
                  <span className="text-base font-bold text-gray-900 sm:min-w-[90px] sm:text-right">
              ...
              <button
                className="flex items-center gap-1 text-yellow-500 text-sm font-medium mt-5 hover:text-yellow-600"
                onClick={() => navigate("/")}
              >
        ...
        {cartItems.length > 0 && (
          ...
          <div className="w-full md:w-72 flex-shrink-0 md:sticky md:top-6 flex flex-col gap-3">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 flex gap-2">
              ...
              <button className="bg-gray-900 text-white text-sm font-semibold px-4 rounded-lg hover:bg-gray-700">
                ใช้งาน
              </button>
            ...
            {/* Desktop Checkout */}
            <button
              className="hidden md:block w-full bg-yellow-400 text-black font-bold py-3.5 rounded-lg text-base hover:bg-yellow-500"
      ...
      {cartItems.length > 0 && (
        <div className="fixed bottom-0 left-0 w-full bg-white border-t p-4 md:hidden">
          ...
          <button
            ...
            onClick={() => navigate("/checkout")}
          >
            สั่งซื้อ ฿{totalPrice.toLocaleString()}
          </button>
