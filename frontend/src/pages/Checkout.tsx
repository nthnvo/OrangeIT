...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Steps Bar */}
      <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-center gap-2 mb-6">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-10 flex gap-5 items-start">

        {/* Left: Form */}
        <div className="flex-1 bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
            <div className="w-7 h-7 rounded-full bg-gray-900 text-white text-xs font-bold flex items-center justify-center">1</div>
            <h2 className="text-base font-bold text-gray-900">ข้อมูลสำหรับจัดส่ง</h2>
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-yellow-400 transition"
            />
          </div>
          ...
          <div className="mb-4">
            <label className="block text-xs font-semibold text-gray-500 mb-1.5">ที่อยู่ *</label>
            <textarea
              name="address"
              value={form.address}
              onChange={handleChange}
              ...
              rows={3}
              className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-yellow-400 transition resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-500 mb-1.5">รหัสไปรษณีย์ *</label>
              <input
                name="zip"
                value={form.zip}
                onChange={handleChange}
        ...
        <div className="w-72 flex-shrink-0 sticky top-6">
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h3 className="text-base font-bold mb-4 pb-4 border-b border-gray-100">สรุปคำสั่งซื้อ</h3>
              ...
              {cartItems.map((item) => (
                <div key={item.id} className="flex items-center gap-3">
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-12 h-12 object-contain bg-gray-50 border border-gray-100 rounded-lg p-1 flex-shrink-0"
                  />
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium text-gray-900 leading-snug line-clamp-2">{item.name}</p>
            ...
            <div className="flex flex-col gap-2.5 pt-4 border-t border-gray-100 mb-4">
            ...
            <button
              className="w-full bg-yellow-400 text-black font-bold py-3.5 rounded-lg text-sm hover:bg-yellow-500 transition"
